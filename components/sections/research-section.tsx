    ...
    <section className="py-16 bg-[#f8f9fa]">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <p className="text-base text-gray-600 max-w-3xl mx-auto mb-8">
          Lexlytic can automate drafting, answer research questions, build
          arguments and compare points of law from multiple jurisdictions.
        </p>
        <Link
          href="/explore"
          className="inline-flex items-center text-blue-500 font-medium hover:text-blue-600"
        >
          Explore Lexlytic <ArrowRight className="ml-2 h-4 w-4" />
        </Link>
        <div className="mt-12">
